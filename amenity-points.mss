@marina-text: #3f52df;
@wetland-text: darken(#3490fd, 25%);
@shop-icon: #992899;
@shop-text: #822482;
@transportation-icon: #1179d7;
@transportation-text: #114cff;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: #6a47b8;
@health-color: #b21111;
@amenity-brown: #583412;
@gastronomy-icon: #bc5911;
@gastronomy-text: darken(@gastronomy-icon, 7%);
@memorials: @amenity-brown;
@culture: @amenity-brown;
@public-service: @amenity-brown;
@office: #33498a;
@man-made-icon: #4c4c4c;
@advertising-grey: @man-made-icon;
@barrier-icon: #2c2c2c;
@landform-color: #c9763d;
@leisure-green: darken(@park, 65%);
@aboriginal: #684a29;
@religious-icon: #111111;

@landcover-font-size: 10;
@landcover-wrap-width-size: 30;
@landcover-line-spacing-size: -1.5;
@landcover-font-size-big: 12;
@landcover-wrap-width-size-big: 36;
@landcover-line-spacing-size-big: -1.8;
@landcover-font-size-bigger: 15;
@landcover-wrap-width-size-bigger: 45;
@landcover-line-spacing-size-bigger: -2.25;
...
#amenity-points {
  ...
  [feature = 'amenity_childcare'] {
    [zoom >= 17] {
      ...
      marker-line-width: 0;
      marker-clip: false;
      marker-fill: darken(@societal_amenities, 85%);
    }
  }
...
#text-point[zoom >= 10] {
  ...
  [feature = 'tourism_viewpoint'][zoom >= 16] {
    ...
    [feature = 'natural_volcano'] { text-fill: #cf1111; }
    text-dy: 7;
  ...
  [feature = 'leisure_pitch'] {
    ...
    [zoom >= 17][way_pixels <= 768000][shop = 'mall'] {
      ...
      [feature = 'landuse_orchard'],
      [feature = 'landuse_plant_nursery'] {
        text-fill: darken(@orchard, 53%);
      }
      [feature = 'landuse_cemetery'],
      [feature = 'amenity_grave_yard'] {
        text-fill: darken(@cemetery, 51%);
      ...
      [feature = 'natural_grassland'],
      [feature = 'landuse_grass'] {
        text-fill: darken(@grass, 56%);
      }
      [feature = 'landuse_allotments'] {
        text-fill: darken(@allotments, 56%);
      }
      [feature = 'landuse_farmyard'] {
        text-fill: darken(@farmyard, 56%);
      }
      [feature = 'landuse_farm'],
      [feature = 'landuse_farmland'],
      [feature = 'landuse_greenhouse_horticulture'] {
        text-fill: darken(@farmland, 62%);
      }
      ...
      [feature = 'man_made_water_works'],
      [feature = 'man_made_works'] {
        text-fill: darken(@industrial, 70%);
      }
      [feature = 'landuse_commercial'] {
        text-fill: darken(@commercial, 70%);
      }
      [feature = 'landuse_brownfield'],
      [feature = 'landuse_landfill'],
      [feature = 'landuse_construction'] {
        text-fill: darken(@construction, 52%);
      }
      [feature = 'tourism_caravan_site'] {
        text-fill: darken(@campsite, 56%);
        text-dy: 15;
      }
      [feature = 'tourism_theme_park'],
      [feature = 'tourism_zoo'] {
      ...
      [feature = 'amenity_college'],
      [feature = 'amenity_university'] {
        text-fill: darken(@societal_amenities, 85%);
      }
      [feature = 'landuse_religious'] {
        text-fill: darken(@place_of_worship, 56%);
      }
      [feature = 'natural_heath'] {
        text-fill: darken(@heath, 43%);
      }
      [feature = 'natural_scrub'] {
      ...
      [feature = 'natural_beach'],
      [feature = 'natural_shoal'] {
        text-fill: darken(@beach, 64%);
      }
      [feature = 'leisure_sports_centre'],
      [feature = 'leisure_stadium'] {
        text-fill: darken(@stadium, 76%);
      }
      [feature = 'leisure_fitness_centre'],
      [feature = 'leisure_fitness_station'] {
        text-fill: @leisure-green;
      ...
      [feature = 'leisure_track'] {
        text-fill: darken(@track, 45%);
      }
      [feature = 'leisure_ice_rink'],
      [feature = 'leisure_pitch'] {
        text-fill: darken(@pitch, 45%);
      }
    }
  }
  ...
  [feature = 'natural_sand'] {
    ...
    [zoom >= 17][way_pixels <= 768000][is_building = 'no'] {
      ...
      [feature = 'natural_bare_rock'] {
        text-fill: darken(@bare_ground, 62%);
      }
      [feature = 'natural_sand'] {
        text-fill: darken(@sand, 58%);
      }
    }
  }
  ...
  [feature = 'natural_glacier'][is_building = 'no'] {
    ...
    [zoom >= 17][way_pixels <= 768000] {
      ...
      text-fill: mix(darken(@glacier, 52%), darken(@glacier-line, 28%), 50%);
      text-face-name: @landcover-face-name;
      text-halo-radius: @standard-halo-radius;
      text-halo-fill: @standard-halo-fill;
      text-placement: interior;
...
#amenity-line {
  ...
  [feature = 'leisure_track'] {
    [zoom >= 16] {
      [zoom >= 17] {
        bridgecasing/line-color: saturate(darken(@pitch, 32%), 20%);
