...
@living-street-fill: #f4f4f4;
@pedestrian-fill: #dcdcec;
@raceway-fill: #ffb3c2;
@road-fill: #dcdcdc;
@footway-fill: #fd6657;
@footway-fill-noaccess: #acacac;
@steps-fill: @footway-fill;
@steps-fill-noaccess: #acacac;
@cycleway-fill: #1111ff;
@cycleway-fill-noaccess: #8282ff;
@bridleway-fill: #116611;
@bridleway-fill-noaccess: #96dc96;
@track-fill: #824c11;
@track-fill-noaccess: #e3baac;
@aeroway-fill: #acacc3;
@runway-fill: @aeroway-fill;
@taxiway-fill: @aeroway-fill;
@helipad-fill: @aeroway-fill;
@access-marking: #efefef;
@access-marking-living-street: #c3c3c3;

@default-casing: #ffffff;
@tertiary-casing: #767676;
@residential-casing: #acacac;
@road-casing: @residential-casing;
@service-casing: @residential-casing;
@living-street-casing: @residential-casing;
@pedestrian-casing: #828282;
...
@tertiary-shield: #2a2a2a;

@unimportant-road: @residential-casing;

@minor-construction: #969696;
@service-construction: #969696;

@destination-marking: #b6e0ff;
@private-marking: #f79595;
@private-marking-for-red: #b64949;

@tunnel-casing: #666666;
@bridge-casing: #111111;

@motorway-tunnel-fill: lighten(@motorway-fill, 12%);
@trunk-tunnel-fill: lighten(@trunk-fill, 13%);
@primary-tunnel-fill: lighten(@primary-fill, 14%);
@secondary-tunnel-fill: lighten(@secondary-fill, 7%);
@tertiary-tunnel-fill: lighten(@tertiary-fill, 5%);
@residential-tunnel-fill: darken(@residential-fill, 2%);
...
@junction-text-color: #7e1111;
@halo-color-for-minor-road: #ffffff;
@lowzoom-halo-color: #ffffff;
@lowzoom-halo-width: 1;

@motorway-oneway-arrow-color: darken(@motorway-casing, 28%);
@trunk-oneway-arrow-color: darken(@trunk-casing, 27%);
@primary-oneway-arrow-color: darken(@primary-casing, 17%);
@secondary-oneway-arrow-color: darken(@secondary-casing, 10%);
@tertiary-oneway-arrow-color: darken(@tertiary-casing, 28%);
@residential-oneway-arrow-color: darken(@residential-casing, 44%);
@living-street-oneway-arrow-color: darken(@residential-casing, 35%);
@pedestrian-oneway-arrow-color: darken(@pedestrian-casing, 26%);
@raceway-oneway-arrow-color: darken(@raceway-fill, 50%);
@footway-oneway-arrow-color: darken(@footway-fill, 34%);
@steps-oneway-arrow-color: darken(@steps-fill, 34%);
@cycleway-oneway-arrow-color: darken(@cycleway-fill, 34%);
@track-oneway-arrow-color: darken(@track-fill, 11%);
@bridleway-oneway-arrow-color: darken(@bridleway-fill, 14%);
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'railway_narrow_gauge'] {
      [zoom >= 8] {
        line-color: #c3c3c3;
        [zoom >= 10] { line-color: #969696; }
        [zoom >= 13] { line-color: #4c4c4c; }
        line-width: 1;
        [zoom >= 13] { line-width: 2; }
        #tunnels {
          line-dasharray: 5,3;
    ...
    [feature = 'railway_miniature'] {
      [zoom >= 15] {
        line/line-width: 1.2;
        line/line-color: #828282;
        dashes/line-width: 3;
        dashes/line-color: #828282;
